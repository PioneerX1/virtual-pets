...
//
//   @Test
//   public void isAlive_confirmsMonsterIsAliveIfAllLevelsAboveMinimum() {
//     Monster testMonster = new Monster("Bubbles", 1);
...
//
//   @Test
//   public void save_recordsTimeLastAteInDatabase() {
//     Monster testMonster = new Monster("Bubbles", 1);
//     testMonster.save();
//     Timestamp savedMonsterLastAte = Monster.find(testMonster.getId()).getLastAte();
//     Timestamp rightNow = new Timestamp(new Date().getTime());
//     assertEquals(rightNow.getDay(), savedMonsterLastAte.getDay());
//   }
//
//   @Test
//   public void save_recordsTimeLastSleptInDatabase() {
//     Monster testMonster = new Monster("Bubbles", 1);
//     testMonster.save();
//     Timestamp savedMonsterLastSlept = Monster.find(testMonster.getId()).getLastSlept();
//     Timestamp rightNow = new Timestamp(new Date().getTime());
//     assertEquals(rightNow.getDay(), savedMonsterLastSlept.getDay());
//   }
//
//   @Test
//   public void save_recordsTimeOfLastPlayedWithInDatabase() {
//     Monster testMonster = new Monster("Bubbles", 1);
//     testMonster.save();
//     Timestamp savedMonsterLastPlayed = Monster.find(testMonster.getId()).getLastPlayed();
//     Timestamp rightNow = new Timestamp(new Date().getTime());
//     assertEquals(rightNow.getDay(), savedMonsterLastPlayed.getDay());
//   }
//
//   @Test
...
//
//   @Test
//   public void play_recordsTimeLastPlayedWithInDatabase() {
//     Monster testMonster = new Monster("Bubbles", 1);
//     testMonster.save();
//     testMonster.play();
//     Timestamp savedMonsterLastPlayed = Monster.find(testMonster.getId()).getLastPlayed();
